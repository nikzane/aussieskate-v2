...
/* Display rinks by state */
			...
			<form name="classic" id="contact_form" action="login2.php" method="POST" enctype="multipart/form-data">
...
?>
				...
				<div class="row" onClick="this.setSelectionRange(0, this.value.length)">
					...
					<input id="password" class="input" name="password" type="text" value="" size="30" placeholder="Phone" onClick="this.setSelectionRange(0, this.value.length)" /><br />
				</div>
